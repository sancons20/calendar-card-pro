...
| `compact_days_to_show`                     | (same as days_to_show)       | Number of days to display in compact mode                                   |
| `compact_events_to_show`                   | (same as max_events_to_show) | Maximum number of events to show in compact mode                            |
| `compact_events_complete_days`             | `false`                      | When true, shows all events for days that have at least one event displayed |
